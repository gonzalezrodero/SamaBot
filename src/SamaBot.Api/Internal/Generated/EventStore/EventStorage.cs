...
namespace Marten.Generated.EventStore
{
    ...
    public sealed class AppendEventOperation : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            var parameter4 = Stream.Key != null ? parameterBuilder.AppendParameter(Stream.Key) : parameterBuilder.AppendParameter<object>(System.DBNull.Value);
            parameter4.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
    ...
    public sealed class GeneratedInsertStream : Marten.Events.Operations.InsertStreamBase
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            var parameterBuilder = builder.CreateGroupedParameterBuilder(',');
            var parameter0 = Stream.Key != null ? parameterBuilder.AppendParameter(Stream.Key) : parameterBuilder.AppendParameter<object>(System.DBNull.Value);
            parameter0.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
    ...
    public sealed class GeneratedStreamVersionOperation : Marten.Events.Operations.UpdateStreamVersion
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            var parameter1 = Stream.Key != null ? parameterBuilder.AppendParameter(Stream.Key) : parameterBuilder.AppendParameter<object>(System.DBNull.Value);
            parameter1.NpgsqlDbType = NpgsqlTypes.NpgsqlDbType.Text;
